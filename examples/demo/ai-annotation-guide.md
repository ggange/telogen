...
Generated by [telogen](https://github.com/ggange/telogen). telogen follows imports
one hop from each route file, but content deeper than that — or inside packages —
is out of its reach. This file is a map of that content: the strings and elements
telogen found but currently can't extract, with the exact spot you'd mark each one.
